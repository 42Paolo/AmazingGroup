...
class Maze:
    ...
    def __init__(
        ...
        self.blocked: set[tuple[int, int]] = set()  # questo mi serve per il
        # disegno del 42

    # tutte funzioni secodnarie per controlli, mi servivano per i controlli
    # sulle celle, senno il codice e ra inleggibile/non chiaro
    ...
    # mi serve per dfs cosicche quando va a generare il percorso a ogni
    # iterazione sapra le celle vicine "raggiungibili"
