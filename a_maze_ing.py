...
# prendo ogni cella la converto in hex e la scrvo nel file,
# successivamnete alla fine andro a scrivere come ultima linea il percorso
# per la soluzione, se non c'e scritto niente e perche non ce la soluzione
